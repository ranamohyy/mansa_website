...
const String notOurStudent ="notOurStudent";

const whiteColor=Colors.white;
const kTextStyle20white= TextStyle(
    fontSize: 20,
    fontWeight: FontWeight.bold,
    color: Colors.white
);
const kTextStyle24white= TextStyle(
    fontSize: 24,
    fontWeight: FontWeight.bold,
    color: Colors.white
);
const kTextStyle16black= TextStyle(
  fontSize: 16,
  color: Colors.black,
  fontStyle: FontStyle.normal,
  fontWeight: FontWeight.bold,
);
const kTextStyle14Black= TextStyle(
  fontSize: 13,
  color: Colors.black,
  fontWeight: FontWeight.normal,
);
const kTextStyle14White= TextStyle(
  fontSize: 14,
  color: Colors.white,
  fontStyle: FontStyle.normal,
...
const kTextStyle15grey = TextStyle(
  fontSize: 15,
  fontWeight: FontWeight.bold,
...
const kTextStyle14underline = TextStyle(
  fontSize: 14,
  color: kPrimaryColor,
  fontWeight: FontWeight.bold,
